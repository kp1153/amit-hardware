    ...
    <footer className="bg-[#0f2d5e] text-white mt-auto">
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="grid grid-cols-3 gap-8 mb-6">
          <div>
            <div className="font-bold mb-2">अमित इण्टरप्राइजेज एण्ड हार्डवेयर</div>
            <div className="text-white/50 text-sm">कोरियानी, भुसियावाँ, अमेठी, उत्तर प्रदेश</div>
          </div>
          <div>
        ...
        <div className="border-t border-white/10 pt-4 flex justify-between items-center text-xs text-white/30">
          <span>© {new Date().getFullYear()} अमित इण्टरप्राइजेज एण्ड हार्डवेयर</span>
