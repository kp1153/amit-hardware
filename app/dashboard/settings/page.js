    ...
    <div className="space-y-6 max-w-lg">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 space-y-4">
        ...
        <div className="space-y-1">
          ...
          <div className="font-semibold">अमित इण्टरप्राइजेज एण्ड हार्डवेयर</div>
        </div>
        <div className="space-y-1">
          <div className="text-sm text-gray-500">पता</div>
          <div className="font-semibold">कोरियानी, भुसियावाँ, अमेठी</div>
        </div>
        <div className="space-y-1">
          <div className="text-sm text-gray-500">मालिक</div>
          <div className="font-semibold">अमित तिवारी</div>
        </div>
