...
export default function GrahakForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-5 space-y-3 max-w-lg">
      <div className="font-bold text-[#0f2d5e]">नया ग्राहक जोड़ें</div>
      ...
      <button type="submit" className="bg-[#0f2d5e] text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:bg-[#1a3f7a]">
        जोड़ें
      </button>
    </form>
  )
